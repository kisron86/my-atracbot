...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    Mat img1, img2, gray1, gray2, img1_r, img2_r;
    VideoCapture cap1 = VideoCapture(0);
    VideoCapture cap2 = VideoCapture(4);
    ...
    while (success < numBoards)
    {
        cap1 >> img1;
        cap2 >> img2;
        //resize(img1, img1_r, Size(320, 240));
        //resize(img2, img2_r, Size(320, 240));
        ...
        imshow("image_right", gray1);
        imshow("image_left", gray2);
        //cout << "tekan c untuk ambil gambar" << endl;
        k = waitKey(10);
        if (found1 && found2)
        {
            cout << "detected" << endl;
        ...
        if (k == 'c' && found1 !=0 && found2 != 0)
        {
            cout << "c di tekan " << endl;
